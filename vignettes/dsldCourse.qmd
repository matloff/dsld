...
To do this, we can add a new variable, tar, as an intermediate step between
smoking and cancer: 
...
backdoor path is blocked, regardless of whether we control for age. Thus, we have successfully isolated the causal path by accounting for age without measuring 
it!
...
just a few nodes and arrows. And as our data becomes more complex, 
[Indirectly meaning through an intermediate variable Z]{.column-margin}
it becomes
