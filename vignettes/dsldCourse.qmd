...
There are a couple of undirected arcs, e.g. between gender and
occupation--relations, but not found to be causal, using available data.
...
Here, even correcting for age, education and so on, we find a
