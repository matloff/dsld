...
<!-- Could remove this example and instead move the next 3 paragraphs to the margin 
- Taha -->
[Another example: as far as we know, there is no connection between contracting 
COVID and having appendicitis. However, someone with either conditions is more likely 
...
However, this method can have unintended negative consequences. Since tar and 
...
more big catch - we are assuming that these graphs are accurate to our data. U
nfortunately, data isn't always simple enough for the relationships between variables 
...
it becomes harder justify certain decisions, like whether a variable X directly 
or indirectly effects another variable Y.
