...
* To enable exploraty analysis of possible discrimination effects
...
**dsldLinear()**.  The second half is the material added by the latter
function.
...
certainly looks nonlinear, possibly reflecting 

age discrimination against both very young and very old workers.  
We are already investigating one kind of discrimination here, gender, 
so again for simplicity let's keep age as a confounder.  
...
definition of linearity.]{.column-margin} 
