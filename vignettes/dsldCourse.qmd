...
gender wage gap, at any age.  
According to the model, younger men earn
...
* What are the assumptions underlying that model?  And how might we [In
  ...
  might be solvable via an advanced (and rather controversial) topic
  known as *causal inference*.  Unfortunately, this is beyond our scope
  here.]{.column-margin} check whether they are (approximately) valid?
...
So, an approximate 95% confidence interval for the gender way gap is
...
on, and you'll many applications of this methodology.  But how would one
...
But we must do something about the substantial nonlinearity
