...
establishing causal relations between features. Although it is possible 
to isolate the relation between 1 feature and another so that we are 
reducing the effect of the non-causal path (e.g. by adding an additional 
step in the causal path unrelated to the confounder), it is crucial to 
be aware that Confidence Intervals don't guarantee the elimination of 
every non-causal path.
