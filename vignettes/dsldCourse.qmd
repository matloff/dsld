...
<!-- Taha: It may be better to remove these next few paragraphs and move
on to the warning to emphasize the need to be aware of CI's pitfalls, as 
opposed to finding workarounds.-->
<!--
...
isolate the relation between features so that we are reducing the 
