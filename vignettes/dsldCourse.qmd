...
regardless of whether we control for age. Thus, we have successfully isolated the 
causal path by accounting for age *without* measuring it!
...
appendicitis, it becomes likely that their hospitalization is due to COVID.]{.column-margin}
