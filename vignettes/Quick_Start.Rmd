...
dummies such as **race1black**.  

We can use the generic **summary** function to inspect coefficients and
other output. Again, note that much of the information here is specific
to discrimination issues, reflecting the fact that **dsld** wrappers
enhance output with discrimination-related material

Let's look at two in particular, **fam_inc** and
...
No, men and women seem to have very similar patterns of education. How
about occupation?  There are six occupational codes.
...
Yes, thre is quite a bit of variation. 

So, we might consider treating occupation as a confounder but not
education.
