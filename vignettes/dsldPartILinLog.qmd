...
z <- dsldML('svcensus',quote(wageinc),'gender',
   qeMLftnName='qeKNN',opts=list(k=50),holdout=1000)  
print(z)  
```
...
matter, resulting in the paper going further than some would have
preferred.  Nor is modernness necessarily a virtue.  But readers of this
book are urged to always keep in mind the two examples
above$\textemdash$family income and an interaction term each having
minuscule impact even though the tests declared them
