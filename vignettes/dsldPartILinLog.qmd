...
victims.  But upon closer inspection, confidence intervals are rather iffy.
For case 555, say, the confidence interval for the difference is
$-0.0707 \pm 1.96 \times 0.0679$, or (-0.2038,0.0624).
...
gcNoY$Gender <- as.numeric(gcNoY$Gender)
gcNoS$Credit_risk <- as.numeric(gcNoS$Credit_risk)
