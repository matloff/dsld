...
\beta_3=0$.  As noted in Appendix A, modern practice discourages such
...
easy question at all, and further investigation would be needed. 
...
```{R}
# w <- dsldML('lsa',quote(bar),'race1',qeMLftnName='qeKNN',opts=list(k=50))  
# print(w)  
```
