...
Our specific purpose here, though, it to find possible confounders.
...
of Y and S, and see which features turn out to predict both well.  The
function **dsldCHunting** does this, using the ML algorithm random
forests.
