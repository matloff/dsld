...
* Most important, for any given dataset, there is no unique DAG; [CMU
professor C. Shalizi has
[lamented](https://www.stat.cmu.edu/~cshalizi/uADA/16/lectures/25.pdf)
bluntly that in such cases one should not present just one DAG without
mentioning the equivalent ones, simply as a matter of "scientific
honesty," yet "This is often what people seem to do." ]{.column-margin}
