...
[![NM](NMHighDef.jpg){width=100%}]{.column-margin}
...
take a random sample of 100 students.  The mean weight of those
students, denoted $\bar{X}$, is an estimate of $\mu$.

I know that $\bar{X}$ will have some amount of error as an estimate of
