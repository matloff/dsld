...
is a senior Computer Science and Engineering student, I have had the
[![BO](BO.jpg){width=35%}]{.column-margin}
privilege of exploring my passion for Machine Learning (ML) and
Artificial Intelligence (AI).  His academic journey has been defined by
a strong commitment to ethical considerations in the development and
deployment of ML/AI models. This dedication is one of the key reasons he
