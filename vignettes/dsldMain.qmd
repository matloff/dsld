...
useful."]{.column-margin} Similarly, in the real world, it is almost
never the case that some variable A has 0.000000 effect on variable B, yet
that is exactly the question addressed by significance tests.  Modern
statistical thinking shies away from p-values, and asks instead whether
A has an effect on B that is substantial enough to be of interest.
