...
Luckily, DSLD provides a host of functions that let you visually explore these 
trends.

### Confounders in Law School Admissions

Suppose we are investigating the relationship between LSAT exams scores and race.
However, there is a big claim that the LSAT and other school admission exams
are heavily dependent on family income, which is impacted by race. So in this 
scenario, we want to graphically see the effects of the C, family income, on the 
relationship between Y, lsat score, and S, race. We will be using the 
**law.school.admissions** data set, a survey of students attending law schools
in the US in 1991.
...
other groups of students, but that is also true across all years. On the family 
...
look for anything that may affect our analysis between race and LSAT scores. 
That being said, we can say that it's possible that family income may be a 
confounder, only because the different levels look fairly different in terms
of the races of the students that populate it.
