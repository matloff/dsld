...
education level influences the relationship between gender and wage.

One way to further explore this scenario is by using the function 
**dsldFrequencyByS()**, 
...
difference in frequencies here is much greater than with the 'educ' example, 
...
Everything is a confounder to *some* degree, so it is up to the analyst to decide 
when a feature is confounding enough to be considered in a model.
