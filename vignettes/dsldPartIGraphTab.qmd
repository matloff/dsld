...
There are a couple things you can gather from this. The age axis doesn't say
much. It looks like there are more white students born during the 1930s than 
...
can make it hard to notice any hidden trends. We are only this graph to look for anything that may affect our analysis between race and LSAT scores. That being
...
to see the racial bias of the LSAT.
...
family income in our models. As always, further investigation is necessary 
