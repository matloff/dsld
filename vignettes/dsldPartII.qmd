...
dsldFairTest(data, yName, sName, dsld::dsldQeFairRF, scorr, nReps = 20, deweightPars = list(decile_score=0, priors_count=0))
                          Metric Misclass Error
...
# Deweight decile_score and priors_count
dsldFairTest(data, yName, sName, dsld::dsldQeFairRF, fairness::prop_parity, nReps = 20, deweightPars = list(decile_score=0, priors_count=0))
                 Proportion Proportional Parity Group size Misclass Error
...
# Deweight decile_score and priors_count
dsld::dsldFairTest(data, yName, sName, dsld::dsldQeFairRF, fairness::equal_odds, nReps = 20, deweightPars = list(decile_score=0, priors_count=0))
                 Sensitivity Equalized odds Group size Misclass Error
...
**increased** at a deweight value of 0, while our utility increases as 
missclassification error decreases.
