...
solution that optimizes for a given fairness constraint, and **(3)** produces 
an intuitive set of coefficients for more effective interpretation.
...
With this in mind, Scutari then trains the model with increasing levels of 
penalty until the desired level of fairness is arrived upon.
