...
Utility in fair ML, and in ML classification algorithms in general, tend
to use acronyms like False Positive Rate (FPR).  These are conditional
probabilities, but it's important not to confuse the event with the
condition.
...
* FPR: FP / (FP + TN) = P(guess Y positive | Y acutally is negative)

* TPR: TP / (TP + FN) = P(guess Y positive | Y acutally is positive)

* FNR: FN / (TP + FN) = P(guess Y negative | Y acutally is positive)

* TNR: TN / (FP + TN) = P(guess Y negative | Y acutally is negative)
